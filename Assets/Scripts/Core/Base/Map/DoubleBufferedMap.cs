...
#pragma warning restore CA1043 // Use Integral Or String Argument For Indexers
        ...
        public void RegisterListener(MapUpdateListener<T> updateListener)
        {
            this.arrayMaps[0].RegisterListener(updateListener);
            this.arrayMaps[1].RegisterListener(updateListener);
        }
